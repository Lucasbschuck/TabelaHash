...
package tabelahashmistura;
import java.util.Random;
public class TabelaHashMistura {
    ...
    Registro[] vetor;
        ...
        public void hashing(int codigo){
           ...
           codigo ^= (codigo >> 20) ^ (codigo >> 12);
           int indice = (codigo ^ (codigo >> 7) ^ (codigo >> 4)) % tamanho;
